...
export const PROJECTS: Project[] = [
  ...
  // ============================================
  {
    ...
    description:
      "The PDF reader AI agents reach for — a Model Context Protocol server with parallel processing, 5–10× faster than typical alternatives.",
    images: [],
    skills: [
      "typescript",
      "nodejs",
  ...
  },
  {
    ...
    title: "CodeRAG",
    description:
      "Semantic code search engine with AST chunking supporting 15+ programming languages.",
    images: [],
    skills: [
      "typescript",
      "nodejs",
  ...
  },
  {
    ...
    title: "Rapid",
    description:
      "Reactive state management library — 2.49KB gzipped, framework-agnostic. Benchmarks in repo.",
    images: [],
    skills: [
      "typescript",
      "react",
  ...
  },
  {
    ...
    title: "Craft",
    description:
      "Immutable state library for TypeScript with ES6 collection support. Benchmarks in repo.",
    images: [],
    skills: [
      "typescript",
      "immutable-data",
  ...
  },
  {
    ...
    title: "xdash",
    description:
      "Modular TypeScript utility library with zero runtime dependencies and tree-shaking support.",
    images: [],
    skills: [
      "typescript",
      "bun",
  ...
  },
  {
    ...
    title: "Spectra",
    description:
      "Dart code generation tool transforming data classes into JSON Schema, OpenAPI, and Protocol Buffers with a single annotation.",
    images: [],
    skills: [
      "dart",
      "code-generation",
  ...
  },
  {
    ...
    title: "xserver",
    description:
      "Dart web server framework with automatic handler registration and type-safe client generation through source code generation.",
    images: [],
    skills: [
      "dart",
      "web-framework",
  ...
  },
  {
    ...
    title: "Dust",
    description:
      "Modern component-based Dart web framework compiled to WebAssembly (WASM). React/Vue inspired with Virtual DOM and keyed diffing.",
    images: [],
    skills: [
      "dart",
      "webassembly",
  ...
  },
  {
    ...
    title: "FireSchema",
    description:
      "Code generation tool for Firestore creating strongly-typed ODM code from JSON Schema. Supports TypeScript, Dart, and C#.",
    images: [],
    skills: [
      "typescript",
      "dart",
  ...
  },
  {
    ...
    title: "Sylphx Flow",
    description:
      "CLI orchestration tool for AI development — supports Claude Code, Cursor, and other AI coding tools.",
    images: [],
    skills: [
      "typescript",
      "nodejs",
  ...
  },
  {
    ...
    title: "DeepResearch",
    description:
      "AI research tool implementing Tree of Thoughts and ReAct methodologies for autonomous investigation on complex topics.",
    images: [],
    skills: [
      "typescript",
      "bun",
  ...
  },
  {
    ...
    title: "KyleML",
    description:
      "Personal ML learning repository with implementations of PPO, AlphaZero MCTS, ICM, and various reinforcement learning algorithms.",
    images: [],
    skills: [
      "python",
      "pytorch",
  ...
  },
  {
    ...
    description:
      "Track and download official Cursor AI editor versions with hourly automatic updates. 13 GitHub stars.",
    images: [],
    skills: [
      "typescript",
      "github-actions",
  ...
  // ============================================
  {
    ...
    title: "Cubeage.com",
    description:
      "Official website and game portal for Cubeage Limited with user management and payment systems",
    images: ["/projects/cubeage/1.jpg"],
    skills: [
      "vue",
      "mysql",
      "ubuntu",
  ...
  },
  {
    ...
    title: "Big 2 Tycoon",
    description:
      "Multiplayer competitive card game with character progression and arena tournaments",
    images: ["/projects/big2-tycoon/1.jpg"],
    skills: [
      "unity3d",
      "typescript",
      "game-development",
    ...
    urls: {
      googlePlay:
        "https://play.google.com/store/apps/details?id=com.gameflask.btthk",
      appStore:
        "https://apps.apple.com/az/app/%E9%8B%A4%E5%A4%A7d%E5%A4%A7%E4%BA%A8-%E6%9C%80%E5%88%BA%E6%BF%80%E7%9A%84%E7%AD%96%E7%95%A5%E6%A3%8B%E7%89%8C%E9%81%8A%E6%88%B2/id1295634408",
    },
    details: [
  ...
  },
  {
    ...
    description:
      "Hong Kong gaming information website with over 500,000 registered users and 3,000+ concurrent online users",
    images: ["/projects/nakuz/1.jpg"],
    skills: [
      "php",
      "mysql",
      "html",
  ...
  },
  {
    ...
    description:
      "Engaging poker game with multiple game modes and social features",
    images: [
    ...
    urls: {
      googlePlay:
        "https://play.google.com/store/apps/details?id=com.cubeage.showhand.app",
      appStore:
        "https://apps.apple.com/az/app/fun-showhand-stud-poker/id1238318956",
      other: [
        {
  ...
  },
  {
    ...
    description:
      "Popular Taiwanese Mahjong game with over 1 million downloads featuring a unique offline gameplay experience with 16-tile Mahjong rules",
    images: [
      "/projects/fmj/1.jpg",
      "/projects/fmj/2.jpg",
      "/projects/fmj/3.jpg",
    ...
    urls: {
      googlePlay:
        "https://play.google.com/store/apps/details?id=com.cubeage.fmj16.app",
      appStore:
        "https://apps.apple.com/us/app/%E7%98%8B%E9%BA%BB%E5%B0%8716%E5%BC%B5-%E6%89%8B%E6%A9%9F%E5%8F%B0%E5%BC%8F%E9%BA%BB%E5%B0%87%E6%A8%82%E5%9C%92/id1252568150",
      wikipedia:
        "https://zh.wikipedia.org/wiki/%E7%98%8B%E9%BA%BB%E5%B0%8716%E5%BC%B5",
      other: [
        {
  ...
  },
  {
    ...
    title: "Anymud",
    description:
      "Modern Medium-like publishing platform with advanced editor capabilities",
    images: ["/projects/anymud/1.jpg"],
    skills: [
      "api-development",
      "digital-marketing",
      "docker",
  ...
  },
  {
    ...
    title: "NovelFeed",
    description:
      "Publisher-focused article sharing platform with enhanced social integration",
    images: [],
    skills: [
      "database-design",
      "database-optimization",
  ...
  },
  {
    ...
    description:
      "Popular gaming platform with physical game cards and digital distribution in Hong Kong",
    images: ["/projects/funimax/1.jpg"],
    skills: [
      "database-design",
      "database-optimization",
      "php",
  ...
  },
  {
    ...
    description:
      "A hybrid DEX platform combining Bancor-Orderbook models for cross-chain trading",
    images: [],
    skills: [
      "typescript",
      "kubernetes",
  ...
  },
  {
    ...
    description:
      "Multi-chain application deployment platform with real-time profit sharing",
    images: [],
    skills: [
      "blockchain",
      "nodejs",
  ...
  },
  {
    ...
    description:
      "Comprehensive mining pool management system with advanced analytics",
    images: [],
    skills: [
      "blockchain",
      "nodejs",
  ...
  },
  {
    ...
    description:
      "Chrome extension to export ChatGPT conversations to JSON, Markdown, plain text, or HTML",
    images: [],
    skills: [
      "typescript",
      "chrome-extension",
  ...
  },
  {
    ...
    description:
      "Chrome extension for efficient bulk deletion of Google Photos",
    images: ["/projects/google-photos-delete/1.jpg"],
    skills: [
      "nodejs",
      "chrome-extension",
      "google-photos-api",
  ...
  },
  {
    ...
    description:
      "Hong Kong gaming IP exchange network and discussion forum with over 200,000 registered users and 1,000+ concurrent online users",
    images: [],
    skills: [
      "php",
      "mysql",
    ...
    urls: {
      ...
      timemachine:
        "https://web.archive.org/web/20241211084528/http://sky-c.com/",
    },
    details: [
  ...
  },
  {
    ...
    title: "A-Graders",
    description:
      "Hong Kong private tutoring matching platform connecting tutors and students",
    images: [],
    skills: [
      "php",
      "mysql",
    ...
    urls: {
      ...
      timemachine:
        "https://web.archive.org/web/20241211084528/https://agraders.com/",
    },
    details: [
  ...
  },
  {
    ...
    title: "Hyperfds",
    description:
      "Hong Kong blogger and social media portal platform for networking and community building",
    images: [],
    skills: [
      "php",
      "mysql",
    ...
    urls: {
      ...
      timemachine:
        "https://web.archive.org/web/20080813211308/http://hyperfds.com/",
    },
    details: [
  ...
  },
  {
    ...
    title: "iPet",
    description:
      "Facebook virtual pet game with raising and fighting mechanics",
    images: [
      "/projects/ipet/1.jpg",
      "/projects/ipet/2.jpg",
      "/projects/ipet/3.jpg",
  ...
  },
  {
    ...
    description:
      "Fast-paced math quiz game with addictive gameplay that challenges your mental calculation speed",
    images: [
  ...
  },
  {
    ...
    title: "Royal Cube",
    description:
      "Space shooting game with numerous warplanes and elaborate map designs",
    images: [
  ...
  },
  {
    ...
    description:
      "The first MMO Mahjong RPG featuring story-driven gameplay and business simulation",
    images: [
    ...
    urls: {
      appStore:
        "https://apps.apple.com/us/app/taiwan-mahjong-tycoon/id1515252812",
      other: [
        {
  ...
  },
  {
    ...
    title: "台灣麻將大亨2",
    description:
      "Taiwanese Mahjong game with character progression, pets, and multiple game modes",
    images: [
    ...
    urls: {
      appStore:
        "https://apps.apple.com/az/app/%E5%8F%B0%E7%81%A3%E9%BA%BB%E5%B0%87%E5%A4%A7%E4%BA%A82/id1589759836",
      other: [
        {
          name: "Data.ai (Google Play)",
  ...
  },
  {
    ...
    description:
      "Unique 3D Mahjong world with multiple game modes and character progression",
    images: [
    ...
    urls: {
      googlePlay:
        "https://play.google.com/store/apps/details?id=com.crazycube.hkmahjongtycoon.app",
      appStore:
        "https://apps.apple.com/az/app/%E9%A6%99%E6%B8%AF%E9%BA%BB%E5%B0%87%E5%A4%A7%E4%BA%A8-%E9%BA%BB%E9%9B%80%E4%BF%BE%E4%BD%A0%E7%8E%A9/id1478835027",
      other: [
        {
          name: "Data.ai (Google Play)",
  ...
  },
  {
    ...
    description:
      "Authentic Taiwanese Big 2 card game with rich features and competitive gameplay",
    images: [
  ...
  },
  {
    ...
    description:
      "Enhanced Big 2 card game with character skills and multiple game modes",
    images: [
    ...
    urls: {
      appStore:
        "https://apps.apple.com/az/app/%E9%8B%A4%E5%A4%A7d%E5%A4%A7%E4%BA%A82-%E6%89%93%E5%90%8C%E8%8A%B1%E9%A0%86/id1593378088",
    },
    details: [
  ...
  },
  {
    ...
    description:
      "Puzzle adventure game inspired by 2248 gameplay with character progression and social features",
    images: [],
    skills: [
      "cocos2d",
      "javascript",
    ...
    urls: {
      googlePlay:
        "https://play.google.com/store/apps/details?id=com.cubeage.ttfe.app",
    },
    details: [
  ...
  },
  {
    ...
    description:
      "Taiwanese-style Big 2 card game with offline play and achievement system",
    images: [
    ...
    urls: {
      googlePlay:
        "https://play.google.com/store/apps/details?id=com.luckystargame.funbig2_tw",
      appStore:
        "https://apps.apple.com/az/app/fun-big-2-taiwan-card-craze/id1251326780",
    },
    details: [
  ...
  },
  {
    ...
    title: "Fun Big 2",
    description:
      "Global version of Big 2 card game with authentic gameplay and offline capabilities",
    images: [
    ...
    urls: {
      googlePlay:
        "https://play.google.com/store/apps/details?id=com.luckystargame.funbigtwo",
      appStore:
        "https://apps.apple.com/az/app/fun-big-2-card-battle-royale/id1247782302",
    },
    details: [
  ...
  },
  {
    ...
    description:
      "Fast-paced 3D poker experience with global competition and no forced ads",
    images: [
    ...
    urls: {
      googlePlay:
        "https://play.google.com/store/apps/details?id=com.luckystargame.texaspoker",
  ...
  },
  {
    ...
    description:
      "Fast-paced Blackjack game with dealer challenges and global competition",
    images: [
    ...
    urls: {
      googlePlay:
        "https://play.google.com/store/apps/details?id=com.cubeage.blackjack.app",
      other: [
        {
          name: "Data.ai (Google Play)",
  ...
  },
  {
    ...
    description:
      "Unique game combining combat mechanics with slot machine gameplay",
    images: [
  ...
  },
  {
    ...
    description:
      "Classic blackjack card game with competitive gameplay and streamlined interface",
    images: [
  ...
  },
  {
    ...
    title: "Math Magus",
    description:
      "Innovative math puzzle game with unique gameplay and kawaii artwork",
    images: [
  ...
  },
  {
    ...
    description:
      "Endless runner game with humorous garbage theme and obstacle avoidance",
    images: [
  ...
  },
  {
    ...
    description:
      "Popular Chinese card game based on the Fight the Landlord (斗地主) gameplay",
    images: [
  ...
  },
  {
    ...
    description:
      "Spot the difference game set in an art museum with mystery storyline",
    images: [
  ...
  },
  {
    ...
    title: "Ｑ麻將16張",
    description:
      "Q-style Mahjong game featuring cat-themed visuals and fast gameplay",
    images: [
  ...
  },
  {
    ...
    title: "OppsDaily",
    description:
      "Medium-like publishing platform with blockchain-based creator rewards and personalized blogging features",
    images: [],
    skills: [
      "vue",
      "mysql",
  ...
  },
  {
    ...
    title: "開心推金幣",
    description:
      "3D coin pusher game with web-based interface and virtual currency system",
    images: ["/projects/happy-coin-pusher/1.jpg"],
    skills: [
      "unity3d",
      "web3",
      "php",
...
// ─────────────────────────────────────────────────────────────────────────────
// Shipped-products view (games + web + tools with real screenshots).
// Single catalog: PROJECTS is the SSOT; this derived view picks entries with a
// usable local screenshot and curates framing. (ADR-169: one catalog file.)
// ─────────────────────────────────────────────────────────────────────────────
...
/**
 * Full shipped catalog for the products section. Skips entries with no usable
 * local screenshot (tiny banners stay out unless a real asset path exists).
 */
...
/** Cached shipped view (stable identity for client memoization). */
export const SHIPPED_PRODUCTS: ShippedProduct[] = getShippedProducts();
