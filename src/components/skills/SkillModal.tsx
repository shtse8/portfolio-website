...
export default function SkillModal({
  ...
  const relatedProjects = getRelatedProjects(skillId);
  const relatedExperiences = getRelatedExperiences(skillId);
  ...
  return (
    <Modal 
      ...
      hasNavigation={true}
      onNext={nextSkill}
      onPrevious={prevSkill}
    >
      <motion.div
        className="bg-white dark:bg-gray-900 rounded-2xl w-full relative shadow-xl overflow-hidden"
      >
        ...
        <div className="relative bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-800/50 dark:to-gray-800/30 p-8 rounded-t-2xl">
          <div className="flex items-center">
            <div className={`${skill.bgColor} text-white p-4 rounded-xl mr-5`}>
