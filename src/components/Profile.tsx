      ...
      <div className="container mx-auto px-4">
        ...
        <div className="bg-gray-100 rounded-lg p-6 shadow-sm">
          <p className="text-gray-800 leading-relaxed">
            Full Stack Developer and Founder with 20+ years of experience architecting distributed systems, game platforms, blockchain solutions, and advanced web applications. 
            ...
            Skilled in both frontend and backend development with strong company and team management experience.
